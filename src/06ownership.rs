...
fn takes_ownership(some_string: String) { // some_string 进入作用域
    println!("{} {:p} {:p}", some_string, &some_string, some_string.as_ptr()); 
...
fn gives_ownership() -> String {
    ...
    println!("{} {:p} {:p} => gives_ownership some_string", some_string, &some_string, some_string.as_ptr()); 
    some_string     // 返回 some_string 并移出给调用的函数
}

// takes_and_gives_back 将传入字符串并返回该值
fn takes_and_gives_back(a_string: String) -> String { // a_string 进入作用域
    println!("{} {:p} {:p} => takes_and_gives_back a_string", a_string, &a_string, a_string.as_ptr()); 
