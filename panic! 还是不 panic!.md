## [`panic!` 还是不 `panic!`](http://120.78.128.153/rustbook/ch09-03-to-panic-or-not-to-panic.html#panic-还是不-panic)
...
### [示例、代码原型和测试都非常适合 panic](http://120.78.128.153/rustbook/ch09-03-to-panic-or-not-to-panic.html#示例代码原型和测试都非常适合-panic)
...
### [当我们比编译器知道更多的情况](http://120.78.128.153/rustbook/ch09-03-to-panic-or-not-to-panic.html#当我们比编译器知道更多的情况)
...
### [错误处理指导原则](http://120.78.128.153/rustbook/ch09-03-to-panic-or-not-to-panic.html#错误处理指导原则)
...
### [创建自定义类型进行有效性验证](http://120.78.128.153/rustbook/ch09-03-to-panic-or-not-to-panic.html#创建自定义类型进行有效性验证)
...
## [总结](http://120.78.128.153/rustbook/ch09-03-to-panic-or-not-to-panic.html#总结)
